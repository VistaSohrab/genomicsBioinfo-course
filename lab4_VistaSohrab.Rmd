...
5) After importing the March 12 and September 12 2020 datasets, dataframes of the 10 countries with the most confirmed cases and deaths are acquired. Lastly, two separate scatterplots for each date has been provided.
```{r}
...
```{r}
#March 12, 2020 scatterplot
ggplot() + geom_point(data=March_Top10, mapping = aes(March_Top10$Total_Confirmed, March_Top10$Total_Deaths)) + xlab("total confirmed cases") + ylab("total deaths") + ggtitle("Countries with Highest COVID-19 Confirmed Cases vs Deaths on 03/12/2020") + theme_bw()
```

```{r}
#September 12, 2020 scatterplot
ggplot() + geom_point(data=Sept_Top10, mapping = aes(Sept_Top10$Total_Confirmed, Sept_Top10$Total_Deaths)) + xlab("total confirmed cases") + ylab("total deaths") + ggtitle("Countries with Highest COVID-19 Confirmed Cases vs Deaths on 09/12/2020") + theme_bw()
```
